...
import { removefromcart,increment } from '../../../redux/actions/Actions'
                                    ...
                                    Cart.map(product => (
                                        <tr>
                                            <td className="hidden pb-4 md:table-cell">
                                                <a href="#">
                                                    <img src={product.image} className="w-20 rounded" alt="Thumbnail" />
                                                </a>
                                            </td>
                                            <td>
                                                <a href="#">
                                                    ...
                                                    <form action method="POST">
                                                        <button type="submit" className="text-gray-700 md:ml-4">
                                                            <small onClick={dispatch(removefromcart(product.id))}>(Remove item)</small>
                                                        </button>
                                                    </form>
                                                </a>
                                            </td>
                                            <td className="justify-center md:justify-end md:flex mt-6">
                                                <div className="w-20 h-10">
                                                    <div className="relative flex justify-center items-center gap-2 flex-row w-full h-8">
                                                       <button> - </button> <p>{quantity}</p> <button onClick={() => dispatch(increment(product.id))}> + </button>
                                                    </div>
                                                </div>
                                            </td>
